...
> **版本基线**：本文为深度学习/强化学习方向的原理内容，代码基于 PyTorch，更新于 2026-09。

## 什么是Deep-Agent？

::: tip 名称说明
本章的"Deep-Agent"指**"深度学习 + Agent"的学术视角**（用深度神经网络做感知、规划与决策）。它与 2025 年 LangChain 发布的 **deepagents** 框架（一个内置"规划 + 文件系统 + 子 Agent"的通用深度 Agent 库）**同名不同物**——后者是工程化的 Agent 编排工具，本章内容则是 RL/神经网络方向的原理性讨论。
:::

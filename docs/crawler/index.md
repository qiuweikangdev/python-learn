...
hero:
  ...
  actions:
    - theme: brand
      text: 开始学习
      link: /crawler/crawler-basics/
    - theme: alt
      text: GitHub
      link: https://github.com/qiuweikangdev/python-learn
features:
  - title: 基础篇 · Day 1-5
    details: 爬虫基础入门，HTTP协议、HTML解析、数据提取、反爬机制
    link: /crawler/crawler-basics/
    icon: 🕷️
  - title: 进阶篇 · Day 6-10
    details: 高级爬虫技术，动态页面、多线程、分布式、数据存储
    link: /crawler/crawler-advanced/
    icon: ⚡
  - title: 实战篇 · Day 11-15
    details: 爬虫项目实战，电商、社交媒体、新闻、数据分析
    link: /crawler/crawler-practice/
    icon: 🚀
---
